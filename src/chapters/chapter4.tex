...
This is further explained in the sections Continuous Integration and Continuous Deployment below.
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=12cm]{src/assets/images/ci-pipeline.JPG}}
