...
This section will {\bf heavily focus on DevOps} since our primary objective has been migrating the \glsxtrshort{ilg} application to a new scalable architecture.
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=15cm]{src/assets/app-screenshots/login.png}}
    \caption{Login page}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=15cm]{src/assets/app-screenshots/campaigns.png}}
    \caption{Campaigns Overview page}
    \label{fig:campaigns-overview}
\end{figure}
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=15cm]{src/assets/app-screenshots/campaigns-add.png}}
    \caption{Add Campaign form}
    \label{fig:campaigns-add-form}
\end{figure}
\newpage
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=15cm]{src/assets/app-screenshots/campaigns-edit.png}}
    \caption{Edit Campaign form}
    \label{fig:campaigns-edit-form-1}
\end{figure}
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=15cm]{src/assets/app-screenshots/users.png}}
    \caption{View Users page}
    \label{fig:users-view-page-1}
\end{figure}
\newpage
\newpage
\begin{figure}[H]
    ...
    \makebox[\textwidth]{\includegraphics[width=15cm]{src/assets/app-screenshots/campaigns-edit.png}}
    \caption{Edit Campaign form}
    \label{fig:campaigns-edit-form-2}
\end{figure}
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=15cm]{src/assets/app-screenshots/users.png}}
    \caption{View Users page}
    \label{fig:users-view-page-2}
\end{figure}\newpage
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=15cm]{src/assets/app-screenshots/users-create.png}}
    \caption{Add User form}
    \label{fig:users-add-form}
\end{figure}
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=15cm]{src/assets/app-screenshots/users-add-credit.png}}
    \caption{Users Add credit form}
    \label{fig:users-add-credit-form}
\end{figure}
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=15cm]{src/assets/app-screenshots/records.png}}
    \caption{Campaigns Records page}
    \label{fig:records-page}
\end{figure}
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=15cm]{src/assets/app-screenshots/analytics-1.png}}
    \caption{Campaigns Analytics page}
    \label{fig:campaigns-analytics-page-1}
\end{figure}
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=15cm]{src/assets/app-screenshots/analytics-2.png}}
    \caption{Campaigns Analytics page}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=15cm]{src/assets/images/prometheus-metrics.JPG}}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=15cm]{src/assets/images/grafana-nodes-monitoring.JPG}}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=15cm]{src/assets/images/kibana-home.JPG}}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=15cm]{src/assets/images/fluentd-config-snippet.JPG}}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=15cm]{src/assets/images/efk-stack-logs.JPG}}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=15cm]{src/assets/images/ionos-block-storage.JPG}}
