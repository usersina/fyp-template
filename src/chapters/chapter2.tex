...
\begin{table}[H]
    ...
    \end{tabularx}
\end{table}
Thouroughly studying our use case, we agreed to create a uniform Helm package to ship our microservices.
We also deemed it necessary to have some common configuration that we simply apply with kubectl such as Ingress rules for convenience.
